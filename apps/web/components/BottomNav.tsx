          ...
          return (
            <li key={it.href} className="text-center">
              <Link href={it.href}
                 ...
                 className={`block text-[0.8rem] px-2 py-2 rounded-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--ll-action)] ${active?"text-[var(--ll-action)]":"text-[var(--ll-text)]"}`}>
